...
PowerShell で統合サービスを有効または無効にするには、[`Enable-VMIntegrationService`](https://technet.microsoft.com/en-us/library/hh848500.aspx) と [`Disable-VMIntegrationService`](https://technet.microsoft.com/en-us/library/hh848488.aspx) を実行します。
...
2. `ゲスト サービス インターフェイス`統合サービスを有効にします
...
3. `ゲスト サービス インターフェイス`統合サービスを無効にします
