...
4. [New-NetIPAddress](https://technet.microsoft.com/en-us/library/hh826150.aspx) を利用して NAT ゲートウェイを構成します。  
...
5. [New-NetNat](https://technet.microsoft.com/en-us/library/dn283361(v=wps.630).aspx) を使用し、NAT ネットワークを構成します。  
